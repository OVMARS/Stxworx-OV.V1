...
import { Users, Zap, ArrowRight, X } from 'lucide-react';
...
const RoleSelectModal: React.FC<RoleSelectModalProps> = ({ open, onSelect, onClose }) => {
  if (!open) return null;
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative w-full max-w-lg mx-4 animate-[fadeUp_0.35s_ease-out]">
        ...
        <div className="relative bg-[#0b0f19] border border-white/10 rounded-2xl p-8 shadow-[0_0_80px_rgba(249,115,22,0.08)]">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-1.5 rounded-lg text-slate-500 hover:text-white hover:bg-white/10 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500/50"
